...
<style>
  ...
  .reader-meta { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:14px 20px; border-bottom:1px solid var(--color-line); font:500 10px/1.4 var(--font-mono); letter-spacing:.06em; }
  ...
  .reader-phase { margin:0 0 12px; color:var(--color-tx-2); font:500 10px/1.5 var(--font-mono); letter-spacing:.09em; text-transform:uppercase; }
  h2 { margin:0 0 16px; max-width:26ch; font:700 clamp(27px, 5vw, 38px)/1.05 var(--font-display); letter-spacing:.005em; text-wrap:balance; }
  .reader-detail { margin:0; max-width:58ch; color:var(--color-tx-2); font:400 16px/1.65 var(--font-body); text-wrap:pretty; overflow-wrap:anywhere; }
  ...
  .reader-goal small { display:block; margin-top:4px; color:var(--color-tx-2); font:400 11px/1.5 var(--font-mono); }
  .reader-footer { padding:11px 20px; border-top:1px solid var(--color-line); display:flex; justify-content:space-between; color:var(--color-tx-3); font:400 9px/1.4 var(--font-mono); letter-spacing:.08em; text-transform:uppercase; }
  .reader-footer span:last-child { letter-spacing:4px; }
  @media (max-width:520px) { .reader-meta { padding:12px 16px; } .reader-passage { padding:24px 17px 28px; min-height:210px; } .reader-detail { font-size:15px; line-height:1.65; } .reader-goal { margin-inline:16px; gap:12px; } }
</style>
