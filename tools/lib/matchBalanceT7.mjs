...
const RAW_T7_SCENARIOS = [
  ...
  { id:'defending_specialist_vs_space', category:'specialist', label:'Defending specialists against space attacks', shared:{ opponentTactics:tactic({ useOfSpace:'pass_into_space', onWin:'counter' }) }, variant:{ subjectSpecialist:'defending', subjectRolePreset:'secure' }, rationale:'Tests whether better defensive execution/recovery reduces opponent output.' },
